...
-   **titular_pais_nacimiento_id (string):** código de país de nacimiento del primer titular declarado, según la codificación de país implementada por INDEC. (hasta 05/2019 nombre campo titular_pais_nacimiento_indec_id)

### DNRPA. Embargos y levantamientos de embargo de autos - AAAA

-   **Nombre:** dnrpa-embargos-lrvantamientos-embargos-autos-AAAA.zip
