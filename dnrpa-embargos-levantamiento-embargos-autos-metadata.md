...
-   **titular_pais_nacimiento_indec_id (string):** código de país de nacimiento del primer titular declarado, según la codificación de país implementada por INDEC.
